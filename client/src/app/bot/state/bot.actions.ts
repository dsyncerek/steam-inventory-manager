...
export enum BotActionTypes {
  GetAllBots = '[Bot] Get all bots',
  GetAllBotsSuccess = '[Bot] Get all bots - success',
  GetAllBotsError = '[Bot] Get all bots - error',
...
export class GetAllBots implements Action {
  readonly type = BotActionTypes.GetAllBots;
}

export class GetAllBotsSuccess implements Action {
  readonly type = BotActionTypes.GetAllBotsSuccess;

  constructor(public payload: { bots: Bot[] }) {}
}

export class GetAllBotsError extends ErrorAction {
  readonly type = BotActionTypes.GetAllBotsError;
}
